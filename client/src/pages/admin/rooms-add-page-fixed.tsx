...
export default function RoomsAddPage() {
  ...
  // Resim yükleme ile ilgili state'ler
  ...
  const createRoomMutation = useMutation({
    ...
    onSuccess: (data: Room) => {
      ...
      // Navigate to rooms page after adding
      window.history.back();
    },
    onError: (error: Error) => {
      toast({
  ...
  // Cihaz türüne göre maksimum genişliği belirleme
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {/* Temel Fiyat alanı kaldırıldı - tamamen takvim bazlı fiyatlandırma kullanılıyor */}
