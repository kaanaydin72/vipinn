...
import { insertHotelPolicySchema, Hotel } from "@shared/schema";
...
export default function HotelPolicyCreatePage() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      checkInTime: "14:00",
      checkOutTime: "12:00",
      childrenPolicy: "12 yaş altı çocuklar ücretsiz konaklar",
      petPolicy: "Evcil hayvanlar kabul edilmez",
      extraBedPolicy: "Talep üzerine ekstra yatak sağlanabilir",
      extraBedPrice: 0,
  ...
  const createPolicyMutation = useMutation({
    mutationFn: async (data: z.infer<typeof formSchema>) => {
      ...
      const res = await apiRequest("POST", "/api/hotel-policies", policyData);
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Başarılı",
        description: "Otel politikası başarıyla oluşturuldu.",
      });
    ...
    onError: (error: Error) => {
      toast({
        title: "Hata",
        description: `Politika oluşturulurken bir hata oluştu: ${error.message}`,
        variant: "destructive",
      });
    },
  });
    ...
    <AdminLayout activeMenuItem="policies">
      <div className="container mx-auto py-6">
        <div className="flex items-center mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold">Yeni Otel Politikası Ekle</h1>
            <p className="text-muted-foreground">
              Yeni bir otel için rezervasyon, iptal ve konaklama koşullarını tanımlayın
            </p>
          </div>
        </div>
